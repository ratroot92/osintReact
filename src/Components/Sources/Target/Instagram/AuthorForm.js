...
componentDidMount(){
  ...
  render(){
    ...
    return (<form method="POST"id='myform' onSubmit={this.handleSubmit}>
       <MDBContainer>
      <MDBBtn onClick={this.toggle}>Add Author Target</MDBBtn>
      ...
      <div className="form-group form-inline mt-5 mb-5">
          <label className="col-4 font-weight-bold  text-primary" Htmlfor="">select Interval</label>
      ...
      <label className="col-4 font-weight-bold  text-primary" Htmlfor="author_type">author type</label>
      ...
      <div className="form-group form-inline">
      <label className="col-4 font-weight-bold  text-primary" Htmlfor="author_type">author id</label>
      ...
      <div className="form-group form-inline">
      <label className="col-4 font-weight-bold  text-primary" Htmlfor="author_type">author account</label>
      ...
      <div className="form-group form-inline">
      <label className="col-4 font-weight-bold  text-primary" Htmlfor="author_type">author name</label>
      ...
      <div className="form-group form-inline">
      <label className="col-4 font-weight-bold  text-primary" Htmlfor="author_type">author url</label>
      ...
      <div className="form-group form-inline">
      <label className="col-4 font-weight-bold  text-primary" Htmlfor="author_type">expired on</label>
...
<div className="form-group form-inline">
                         <label className="col-4 font-weight-bold text-primary" Htmlfor="">Other Options </label>
